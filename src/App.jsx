...
const IconLinkedin = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <path fill="#0A66C2" d="M22.23 0H1.77C.79 0 0 .79 0 1.77v20.46c0 .98.79 1.77 1.77 1.77h20.46c.98 0 1.77-.79 1.77-1.77V1.77c0-.98-.79-1.77-1.77-1.77zM7.18 20.45H3.59V9H7.18v11.45zM5.39 7.42a2.03 2.03 0 1 1 0-4.06 2.03 2.03 0 0 1 0 4.06zm15.06 13.03h-3.59v-5.68c0-1.36-.03-3.11-1.9-3.11-1.91 0-2.2 1.49-2.2 3.01v5.78H9.07V9h3.44v1.58h.05c.48-.92 1.65-1.9 3.4-1.9 3.65 0 4.33 2.4 4.33 5.52v6.25z"/>
  </svg>
);
